...
public class taobaoanalysis {
	 ...
	 * @return
	 */
	public static JSONArray deal(String straddress){
		...
		String  accountAmount = list.get(0).get(0);
		...
		String accumulatedAmount=list.get(1).get(0);
		...
		String antAmount=list.get(0).get(1);
		antAmount=list.get(0).get(1).substring(list.get(0).get(1).indexOf("总额度"), list.get(0).get(1).indexOf("查看")).substring(4);
		ALLmount.put("antAmount",antAmount );//花呗可用额度 **.**
