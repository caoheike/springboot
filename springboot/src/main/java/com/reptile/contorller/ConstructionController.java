...
public class ConstructionController {
	...
	public Map<String,Object> Construction(HttpServletRequest request,@RequestParam("UserCard") String UserCard,@RequestParam("UserCode") String UserCode,@RequestParam("CodePass") String CodePass) throws Exception{
		return con.check(request, UserCard, UserCode, CodePass);
	}
}
