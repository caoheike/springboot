...
import com.reptile.service.accumulationfund.ChongQingAccumulationfundService;
/**
 * 
 * @ClassName: ChongQingAccumulationfundController  
 * @Description: TODO  
 * @author: fangshuang
 * @date 2017年12月29日  
 *
 */
@Controller
@RequestMapping("ChongQingAccumulationfundController")
public class ChongQingAccumulationfundController {
	@Autowired
    private ChongQingAccumulationfundService service;
